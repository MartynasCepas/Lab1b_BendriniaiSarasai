...
//        checkCarMarketSorting();
    ...
    void createCarList() {
        ...
        cars.add(0, new Item("Mazda","6",2007,50000,27000));
        cars.add(7, new Item("Hyundai","Lantra",1998,9500,777));
        cars.println("Pridejus");
        cars.set(4, c3);
        ...
        cars.removeFirst();
        cars.println("Po remove first");
        cars.remove(c2);
    //    cars.remove(0); cars.remove(0); cars.remove(0);
    //    cars.remove(0); cars.remove(0); cars.remove(0);
        cars.println("po remove object");
        ItemList cars0 = new ItemList();
        cars0.add(c3);
        cars0.add(c2);
        cars.retainAll(cars0);
        
       cars.println("Po retainall");
    //    cars.remove(0);
    ...
    void checkCarMarketSorting() {
        ...
        market.allCars.println("Bandomasis rinkinys");
        market.allCars.sortBuble(Item.byMakeAndModel);
        market.allCars.println("Rūšiavimas pagal Markę ir Modelį");
        market.allCars.sortBuble(Item.byPrice);
        market.allCars.println("Rūšiavimas pagal kainą");
        market.allCars.sortBuble(Item.byYearAndPrice);
    ...
    static Comparator byMileage = new Comparator() {
        ...
        public int compare(Object obj1, Object obj2) {
            int m1 = ((Item) obj1).getMileage();
            int m2 = ((Item) obj2).getMileage();
