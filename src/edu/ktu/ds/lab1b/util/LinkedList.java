...
public class LinkedList<E extends Comparable<E>>
    ...
    public boolean add(int k, E e) {
        ...
        if(k == 0){
            Node<E> e0 = new Node(e, first);
            first = e0;
            size++;
            return true;
        }
        if(k == size){
            Node<E> e0 = new Node(e, null);
            last.next = e0;
            last = e0;
            size++;
            return true;
        ...
        if(k > 0 && k < size){
            Node<E> search = first;
            Node<E> left = search.findNode(k - 1);
            Node<E> right = search.findNode(k);
            Node<E> e0 = new Node(e, right);
            left.next = e0;
            size++;
            return true;
        }
    ...
    public E set(int k, E e) {
        ...
        if(e == null){
            ...
            Node<E> search = first;
            Node<E> e0 = search.findNode(k);
            E removed = e0.element;
            e0.element = e;
            return removed;
        }
    }
    ...
    public boolean remove(Object o){
        int k = 0;
        for (java.util.Iterator iterator = iterator(); iterator.hasNext();) {
    ...
    public void removeRange(int fromIndex, int toIndex){
        ...
        for(int i = fromIndex; i <= toIndex; i++){
            ...
            if(i == 0){
                ...
                Node<E> search = first;
                Node<E> left = search.findNode(i - 1);
                last = left;
                size--;
            }
